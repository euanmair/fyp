...
resource "aws_instance" "app_server" {
  ...
  instance_type = "m7i-flex.large" # 2 vCPUs, 8 GiB RAM - $0.13 per/hour EU-NORTH-1 - using this for showcase
  # instance_type = "t3.small" # 2 vCPUs, 2 GiB RAM - $0.0504 p/h EU-NORTH-1 - using this for production
